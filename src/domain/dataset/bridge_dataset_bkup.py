...
class BridgeDataset(Dataset):
    ...
    def __init__(
        ...
        self.tokenizer = BridgeTokenizer(device=self.device)
        self.phon_vocab_size = self.tokenizer.phoneme_tokenizer.get_vocabulary_size()
        self.orth_vocab_size = self.tokenizer.character_tokenizer.get_vocabulary_size()
