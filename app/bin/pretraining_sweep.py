...
# TODO: fix this code, move config to yaml, remove code redundancy
...
sweep_config = {
    ...
    "parameters": {
        "batch_size_train": {"values": [32, 64]},
        "batch_size_val": {"values": [32, 64]},
        "d_model": {"values": [128]},
        "d_embedding": {"values": [1]},
        "num_epochs": {"values": [100]},
        "learning_rate": {"values": [0.0001, 0.001]},
        "num_phon_enc_layers": {"values": [8, 16, 32]},
        "num_phon_dec_layers": {"values": [2, 4, 8, 16, 32]},
